...
type FirmwareConfig struct {
	...
	// This supports following options: true, false.
	// +kubebuilder:validation:Enum="true";"false"
	LLCPrefetchEnabled string `json:"llcPrefetchEnabled,omitempty"`

	// This supports following options: true, false.
	// +kubebuilder:validation:Enum="true";"false"
	NUMAEnabled string `json:"numaEnabled,omitempty"`

	// This supports following options: true, false.
	// +kubebuilder:validation:Enum="true";"false"
	CStateEnabled string `json:"cStateEnabled,omitempty"`
}
