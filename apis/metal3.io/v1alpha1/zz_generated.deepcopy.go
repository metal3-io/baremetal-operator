...
func (in *AppliedPortConfig) DeepCopyInto(out *AppliedPortConfig) {
	*out = *in
	in.SwitchPortConfig.DeepCopyInto(&out.SwitchPortConfig)
	if in.LocalLinkConnection != nil {
		in, out := &in.LocalLinkConnection, &out.LocalLinkConnection
		*out = new(SwitchPortIdentifier)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppliedPortConfig.
func (in *AppliedPortConfig) DeepCopy() *AppliedPortConfig {
	if in == nil {
		return nil
	}
	out := new(AppliedPortConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BareMetalHostStatus) DeepCopyInto(out *BareMetalHostStatus) {
	*out = *in
	...
	if in.AppliedPortConfigs != nil {
		in, out := &in.AppliedPortConfigs, &out.AppliedPortConfigs
		*out = make([]AppliedPortConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
