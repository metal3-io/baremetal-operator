...
bar and quo, modify the `config/base/manager.yaml` file. Add the following
...
`Rolebindings` for each namespaces that you added in WATCH_NAMESPACE in env
variable controller-manager Deployment. you need to remove cluster wide
