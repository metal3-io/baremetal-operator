...
```
  ...
  Also, run `./hack/verify-release.sh` this script after tag is created and
  draft relase is ready, just before publishing release to check existance of
  release artifacts and existance of correct release tags.
