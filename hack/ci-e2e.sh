...
CIRROS_BASEURI="https://download.cirros-cloud.net/${CIRROS_VERSION}/${IMAGE_FILE}"
ISO_BASEURI="https://sourceforge.net/projects/systemrescuecd/files/sysresccd-x86/${SYSRESCUE_VERSION}/${ISO_FILE}/download"
