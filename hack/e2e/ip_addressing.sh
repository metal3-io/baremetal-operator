...
#              files that are only missing these IP addresses. If the first
#              argument provided is "clean", instead of injecting variables to
#              templates, the created templates are deleted.
