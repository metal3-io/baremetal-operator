...
func retrievePreprovisioningExtraKernelParamsSpec(info *reconcileInfo) string {
	...
	if info.host.Spec.PreprovisioningExtraKernelParams != "" {
		preprovisioningExtraKernelParams = info.host.Spec.PreprovisioningExtraKernelParams
	}
	return preprovisioningExtraKernelParams
}
