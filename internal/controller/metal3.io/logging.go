...
const (
	...
	// LogFieldNamespace is a Kubernetes namespace.
	...
	// LogFieldHostFirmwareSettings is the name of the HostFirmwareSettings resource.
	LogFieldHostFirmwareSettings = "hostFirmwareSettings"

	// LogFieldHostFirmwareComponents is the name of the HostFirmwareComponents resource.
	LogFieldHostFirmwareComponents = "hostFirmwareComponents"
