			...
			hostClaim: &metal3api.HostClaim{
				...
				Spec: metal3api.HostClaimSpec{
					UserData: &corev1.SecretReference{
						Name:      "test-secret",
						Namespace: differentNamespace, // Different from host's namespace
					},
				},
			},
		...
		},
		{
			...
			hostClaim: &metal3api.HostClaim{
				...
				Spec: metal3api.HostClaimSpec{
					UserData: &corev1.SecretReference{
						Name:      "test-secret1",
						Namespace: claimNamespace, // Same as host's namespace
					},
					NetworkData: &corev1.SecretReference{
						Name:      "test-secret2",
						Namespace: claimNamespace, // Same as host's namespace
