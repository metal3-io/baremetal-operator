...
// service shaped like the minimum viable backend in docs/redfish-inspection.md.
...
func inspectProvisioner(t *testing.T, srv *httptest.Server, events *[]string) *starlarkProvisioner {
	...
	globals, err := starscript.LoadScript(filepath.Join("scripts", "redfish-inspect.star"), starlib.Builtins())
	if err != nil {
