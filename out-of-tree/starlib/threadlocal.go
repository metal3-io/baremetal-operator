...
const (
	...
	// Carries the per host callback base URL and synthesized token.
	CallbackThreadLocal = "metal3-callback"
	// Carries the per host serve base URL and shared serve registry.
	ServeThreadLocal = "metal3-serve"
)
