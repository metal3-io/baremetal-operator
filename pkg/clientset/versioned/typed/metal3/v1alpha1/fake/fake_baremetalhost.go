...
var baremetalhostsResource = schema.GroupVersionResource{Group: "metal3.io", Version: "v1alpha1", Resource: "baremetalhosts"}

var baremetalhostsKind = schema.GroupVersionKind{Group: "metal3.io", Version: "v1alpha1", Kind: "BareMetalHost"}

// Get takes name of the bareMetalHost, and returns the corresponding bareMetalHost object, and an error if there is any.
func (c *FakeBareMetalHosts) Get(name string, options v1.GetOptions) (result *v1alpha1.BareMetalHost, err error) {
	obj, err := c.Fake.
...
func (c *FakeBareMetalHosts) List(opts v1.ListOptions) (result *v1alpha1.BareMetalHostList, err error) {
	obj, err := c.Fake.
...
func (c *FakeBareMetalHosts) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeBareMetalHosts) Create(bareMetalHost *v1alpha1.BareMetalHost) (result *v1alpha1.BareMetalHost, err error) {
	obj, err := c.Fake.
...
func (c *FakeBareMetalHosts) Update(bareMetalHost *v1alpha1.BareMetalHost) (result *v1alpha1.BareMetalHost, err error) {
	obj, err := c.Fake.
...
func (c *FakeBareMetalHosts) UpdateStatus(bareMetalHost *v1alpha1.BareMetalHost) (*v1alpha1.BareMetalHost, error) {
	obj, err := c.Fake.
...
func (c *FakeBareMetalHosts) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(baremetalhostsResource, c.ns, name), &v1alpha1.BareMetalHost{})

	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeBareMetalHosts) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(baremetalhostsResource, c.ns, listOptions)
...
func (c *FakeBareMetalHosts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.BareMetalHost, err error) {
	obj, err := c.Fake.
