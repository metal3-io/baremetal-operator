...
import (
	...
	metalkubev1alpha1 "github.com/metalkube/bare-metal-operator/pkg/apis/metalkube/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &metalkubev1alpha1.BareMetalHost{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// Reconcile reads that state of the cluster for a BareMetalHost object and makes changes based on the state read
// and what is in the BareMetalHost.Spec
...
func (r *ReconcileBareMetalHost) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set BareMetalHost instance as the owner and controller
...
func newPodForCR(cr *metalkubev1alpha1.BareMetalHost) *corev1.Pod {
