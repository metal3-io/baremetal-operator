...
//
//	poolManager, err := libvirt.NewPoolManager(conn)
//	pool, err := poolManager.EnsurePool(ctx, api.PoolConfig{
//	    Name: "my-pool",
...
// for example by checking the underlying libvirt error where appropriate.
package libvirt
